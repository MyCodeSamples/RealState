<x-layout>
    ...
    @enderror
     ...
     <input type="text" name="name" value="{{$owner->name}}" class="form-control" placeholder="Enter Name">
     @error('name')
        <Span class="error-field text-danger">{{$message}}</Span>
    @enderror
        </div>
        <div class="col-md-6">
            ...
            <input type="email" name="email" value="{{$owner->email}}" class="form-control" placeholder="Enter Email">
            @error('email')
            <Span class="error-field text-danger">{{$message}}</Span>
        @enderror
        </div>
    ...
    <div class="row form-group">
        ...
        {{-- <div class="col-md-6">
            ...
            <input type="password" value="{{$owner->password}}" name="password" class="form-control" placeholder="Enter Password*">
            @error('password')
            <Span class="error-field text-danger">{{$message}}</Span>
        @enderror
        </div> --}}
    ...
    <div class="row form-group">
        ...
        <div class="col-md-6">
            ...
            <input type="number" value="{{$owner->phone}}" name="phone" class="form-control" placeholder="Enter Phone*">
            @error('phone')
            <Span class="error-field text-danger">{{$message}}</Span>
        @enderror
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="text" value="{{$owner->website_link}}" name="website_link" class="form-control" placeholder="Enter Website Link">
            @error('website_link')
            <Span class="error-field text-danger">{{$message}}</Span>
        @enderror
        </div>
    ...
    <div class="row form-group">
        <div class="col-md-6">
            ...
            <textarea type="text" class="form-control" name="description" placeholder="Enter Description...">{{$owner->description}}</textarea>
            @error('description')
            <Span class="error-field text-danger">{{$message}}</Span>
        @enderror
        </div>
            <div class="col-md-6">
                ...
                <input type="text" name="location" value="{{$owner->location}}" class="form-control" placeholder="Enter Location">
                @error('location')
            <Span class="error-field text-danger">{{$message}}</Span>
            @enderror
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="hidden" name="oldlogo" id="oldlogo" class="form-control" value="{{$owner->logo}}">
                <input type="file" name="logo" id="logo" class="form-control">
                @error('logo')
                    <span class="field_error text-danger">{{ $message }}</span>
                @enderror
                @if(!empty($owner->logo))
                <img src="{{URL::to($owner->logo)}}">
                @endif
            </div>
            <div class="col-md-4">
