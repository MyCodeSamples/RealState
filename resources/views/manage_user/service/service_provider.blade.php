    ...
    <div class="p-4">
        <div class="card p-4">
            <div class="card-header" style="margin: 1px;">
                ...
                <h5 style="width: 50%;margin: 10px;"> Add Service Providers!</h5>
        </div>
            <div style="padding-left: 100px;padding-right: 100px;">
                <form  action="{{ route('add.service.provider') }}" method="POST" enctype="multipart/form-data"
                    class="pl-5">

                    @csrf
                    <div class="row form-group">
                        <div class="col-md-6">
                            <label for="provider">Services</label>
                            <select name="provider" id="provider" class="form-control">
                                <option selected disabled>Select Services</option>
                                <option value="Builder Developers">Builder Developers</option>
