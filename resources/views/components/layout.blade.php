  ...
  <ul class="menu-inner py-1">
    <li class="menu-item ">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item ">
            <a href="{{route('list.service.provider')}}" class="menu-link" >
                        <div>Service Providers</div>
            </a>
        </li>
        <li class="menu-item ">
            <a href="{{route('builder.list')}}" class="menu-link" >
                        <div>Builders</div>
            </a>
        </li>
        <li class="menu-item ">
        ...
        <li class="menu-item ">
            <a href="{{route('owner.list')}}" class="menu-link" >
                        <div>Owners</div>
            </a>
        </li>
        <li class="menu-item ">
    ...
    <li class="menu-item ">
      ...
      <li class="menu-item ">
        <a href="{{route('ameneties.list')}}" class="menu-link" >
         <div>Ameneties</div>
        </a>
    </li>
    <li class="menu-item ">
        <a href="{{route('countries.list')}}" class="menu-link" >
                    <div>Countries</div>
        </a>
    </li>
    <li class="menu-item ">
        <a href="{{route('states.list')}}" class="menu-link" >
                    <div>States</div>
        </a>
    </li>

    <li class="menu-item ">
        <a href="{{route('cities.list')}}" class="menu-link"  >
                    <div>Cities</div>
        </a>
       </li>
      <li class="menu-item ">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      <div class="flex-shrink-0 me-3">
                        <div class="avatar">
                          <img src="{{ URL::to('assets/img/avatars/2.png') }}" alt class="w-px-40 h-auto rounded-circle">
                        </div>
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      <div class="flex-shrink-0 me-3">
                        <div class="avatar">
                          <img src="{{ URL::to('assets/img/avatars/9.png') }}" alt class="w-px-40 h-auto rounded-circle">
                        </div>
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      <div class="flex-shrink-0 me-3">
                        <div class="avatar">
                          <img src="{{ URL::to('assets/img/avatars/5.png') }}" alt class="w-px-40 h-auto rounded-circle">
                        </div>
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item">
                    <div class="d-flex">
                      <div class="flex-shrink-0 me-3">
                        <div class="avatar">
                          <img src="{{ URL::to('assets/img/avatars/6.png') }}" alt class="w-px-40 h-auto rounded-circle">
                        </div>
                      </div>
                      <div class="flex-grow-1">
                  ...
                  <span class="align-middle">
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-dropdown-link :href="route('logout')"
                            ...
                            <i class='bx bx-log-in me-2'></i>  {{ __('Log Out') }}
                        </x-dropdown-link>
                    </form>
                  </span>
                </a>
...
<footer class="content-footer footer bg-footer-theme">
  <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
    <div class="mb-2 mb-md-0">
      ...
      , made with ❤️ {{env('app.name','Propeties')}}
    </div>
...
<!-- BEGIN: Datatable JS-->
<script src="{{URL::to('assets/vendor/libs/datatables/jquery.dataTables.js')}}"></script>
<script src="{{URL::to('assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js')}}"></script>
<script src="{{URL::to('assets/vendor/libs/datatables-responsive/datatables.responsive.js')}}"></script>
<script src="{{URL::to('assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.js')}}"></script>
...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Sep 2022 07:08:50 GMT -->
</html>
