      ...
      <div class="d-flex align-items-end row">
        ...
        <div class="col-sm-5 text-center text-sm-left">
          <div class="card-body pb-0 px-0 px-md-4">
            <img src="{{URL::to('assets/img/illustrations/man-with-laptop-light.png')}}" height="140" alt="View Badge User" >
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{URL::to('assets/img/icons/unicons/wallet-info.png')}}" alt="Credit Card" class="rounded">
              </div>
              <div class="dropdown">
      ...
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
              <div class="avatar flex-shrink-0">
                <img src="{{URL::to('assets/img/icons/unicons/paypal.png')}}" alt="Credit Card" class="rounded">
              </div>
              <div class="dropdown">
        ...
        <div class="tab-content p-0">
          <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
            <div class="d-flex p-4 pt-3">
              <div class="avatar flex-shrink-0 me-3">
                <img src="{{URL::to('assets/img/icons/unicons/wallet.png')}}" alt="User">
              </div>
              <div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <ul class="p-0 m-0">
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="{{URL::to('assets/img/icons/unicons/paypal.png')}}" alt="User" class="rounded">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="{{URL::to('assets/img/icons/unicons/wallet.png')}}" alt="User" class="rounded">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="{{URL::to('assets/img/icons/unicons/chart.png')}}" alt="User" class="rounded">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex mb-4 pb-1">
            <div class="avatar flex-shrink-0 me-3">
              <img src="{{URL::to('assets/img/icons/unicons/cc-success.png')}}" alt="User" class="rounded">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
          ...
          <li class="d-flex">
            <div class="avatar flex-shrink-0 me-3">
              <img src="{{URL::to('assets/img/icons/unicons/cc-warning.png')}}" alt="User" class="rounded">
            </div>
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              <div class="me-2">
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex">
                <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                  <img src="{{URL::to('assets/img/icons/misc/pdf.png')}}" alt="PDF image" width="23" class="me-2">
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex flex-wrap">
                <div class="avatar me-3">
                  <img src="{{URL::to('assets/img/avatars/3.png')}}" alt="Avatar" class="rounded-circle" />
                </div>
                <div>
            ...
            <div class="timeline-event pb-0">
              ...
              <div class="d-flex align-items-center avatar-group">
                ...
                <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Marrie Patty">
                  <img src="{{URL::to('assets/img/avatars/12.png')}}" alt="Avatar" class="rounded-circle">
                </div>
                <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Jimmy Jackson">
                  <img src="{{URL::to('assets/img/avatars/9.png')}}" alt="Avatar" class="rounded-circle">
                </div>
                ...
                <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Nelson Wilson">
                  <img src="{{URL::to('assets/img/avatars/14.png')}}" alt="Avatar" class="rounded-circle">
                </div>
              </div>
            </div>
          </li>
            ...
            <table class="table table-borderless text-nowrap">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/chrome.png')}}" alt="Chrome" height="24" class="me-2">
                      <span>Chrome</span>
                    </div>
                  </td>
                  <td>8.92k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/safari.png')}}" alt="Safari" height="24" class="me-2">
                      <span>Safari</span>
                    </div>
                  </td>
                  <td>7.29k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/firefox.png')}}" alt="Firefox" height="24" class="me-2">
                      <span>Firefox</span>
                    </div>
                  </td>
                  <td>6.11k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/edge.png')}}" alt="Edge" height="24" class="me-2">
                      <span>Edge</span>
                    </div>
                  </td>
                  <td>5.08k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/opera.png')}}" alt="Opera" height="24" class="me-2">
                      <span>Opera</span>
                    </div>
                  </td>
                  <td>3.93k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/brave.png')}}" alt="Brave" height="24" class="me-2">
                      <span>Brave</span>
                    </div>
                  </td>
                  <td>3.19k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/vivaldi.png')}}" alt="Vivaldi" height="24" class="me-2">
                      <span>Vivaldi</span>
                    </div>
                  </td>
                  <td>1.29k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/uc.png')}}" alt="UC Browser" height="24" class="me-2">
            ...
            <table class="table table-borderless">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/windows.png')}}" alt="Windows" height="24" class="me-2">
                      <span>Windows</span>
                    </div>
                  </td>
                  <td>875.24k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/mac.png')}}" alt="Mac" height="24" class="me-2">
                      <span>Mac</span>
                    </div>
                  </td>
                  <td>89.68k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/ubuntu.png')}}" alt="Ubuntu" height="24" class="me-2">
                      <span>Ubuntu</span>
                    </div>
                  </td>
                  <td>37.68k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/cent.png')}}" alt="Cent" height="24" class="me-2">
                      <span>Cent</span>
                    </div>
                  </td>
                  <td>32.25k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/linux.png')}}" alt="Linux" height="24" class="me-2">
                      <span>Linux</span>
                    </div>
                  </td>
                  <td>22.15k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/fedora.png')}}" alt="Fedora" height="24" class="me-2">
                      <span>Fedora</span>
                    </div>
                  </td>
                  <td>1.13k</td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center">
                      <img src="{{URL::to('assets/img/icons/brands/vivaldi-os.png')}}" alt="Vivaldi" height="24" class="me-2">
                      <span>Vivaldi</span>
                    </div>
                  </td>
                  <td>1.09k</td>
